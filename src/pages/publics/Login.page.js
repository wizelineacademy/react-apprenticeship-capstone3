...
padding: 25px;   
background-color: lightblue; background-color: #4CAF50;   
width: 100%;  
color: black;   
padding: 15px;   
margin: 10px 0px;   
...
const Login = ({ history }) => {
    ...
    return (
        <>
            <center> <h1> Welcome to Capstone 3</h1> </center>
            <form>
                <LoginContainer>
                    <label>Username : </label>
                    <LogginInput type="text" placeholder="Enter Username" name="username" required value={email} onChange={(e) => setEmail(e.target.value)} />
